...
def _redirect_uri(request: HttpRequest) -> str:
    return request.build_absolute_uri("/integrations/basecamp/callback/")
...
def callback(request: HttpRequest) -> HttpResponse:
    ...
    expected = request.session.pop("basecamp_oauth_state", None)
    ...
    integration, _ = Integration.objects.get_or_create(provider="basecamp")
