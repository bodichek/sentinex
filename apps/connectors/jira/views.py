...
def _redirect_uri(request: HttpRequest) -> str:
    return request.build_absolute_uri("/integrations/jira/callback/")
...
def callback(request: HttpRequest) -> HttpResponse:
    ...
    integration, _ = Integration.objects.get_or_create(provider="jira")
    ...
    integration.meta = {
        ...
        "site_name": tokens.get("site_name"),
    }
