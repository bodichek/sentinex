"""Celery tasks — SmartEmailing sync per tenant."""
...
from apps.connectors.smartemailing.sync import run_sync


@shared_task(name="connectors.smartemailing.sync")  # type: ignore[untyped-decorator]
...
@shared_task(name="connectors.smartemailing.dispatch")  # type: ignore[untyped-decorator]
def dispatch() -> int:
